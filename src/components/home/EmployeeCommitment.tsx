        ...
        <div className={`grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-16 transform transition-all duration-1000 delay-500 ${
          ...
          {cultureHighlights.map((highlight, index) => (
            ...
            >
              ...
              <div className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{highlight.stat}</div>
              <div className="text-base sm:text-lg font-semibold text-[#E70051] mb-1">{highlight.label}</div>
